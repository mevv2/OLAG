...
export class EditDataComponent implements OnInit {
  ...
  columnDefs = [
    { headerName: 'Learning Event', field: 'LearningEvent', width: 150 , resizable: true },
    { headerName: 'Learning Activity', field: 'LearningActivity', width: 150, resizable: true },
    { headerName: 'Indicator', field: 'Indicator', width: 300, resizable: true },
